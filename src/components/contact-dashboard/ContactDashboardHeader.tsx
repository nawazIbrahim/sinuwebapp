...
interface ContactDashboardHeaderProps {
  onSave: () => void;
  onBack: () => void;
}

export function ContactDashboardHeader({ onSave, onBack }: ContactDashboardHeaderProps) {
  return (
    <header className="flex-shrink-0 bg-[#94a3b8] border-b border-white/10 shadow-sm px-4 h-16 flex items-center justify-between">
      ...
      {/* Title */}
      <h1 className="text-lg font-bold text-white">Contact Settings</h1>
