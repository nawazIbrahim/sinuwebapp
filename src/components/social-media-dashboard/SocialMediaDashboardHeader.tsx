...
interface SocialMediaDashboardHeaderProps {
  onSave: () => void;
  onBack: () => void;
}

export function SocialMediaDashboardHeader({ onSave, onBack }: SocialMediaDashboardHeaderProps) {
  return (
    <header className="flex-shrink-0 bg-[#94a3b8] border-b border-white/10 shadow-sm px-4 h-16 flex items-center justify-between">
      ...
      {/* Title */}
      <h1 className="text-lg font-bold text-white">Social Media Settings</h1>
